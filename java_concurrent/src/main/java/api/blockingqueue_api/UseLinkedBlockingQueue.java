...
public class UseLinkedBlockingQueue {
    ...
    private static void useAdd() {
        ...
        System.out.println("add 1-->"+linkedBlockingQueue.add(1));
        System.out.println("add 2-->"+linkedBlockingQueue.add(2));
        System.out.println("add 3-->"+linkedBlockingQueue.add(3));
        System.out.println("队列已插满");
        System.out.println(linkedBlockingQueue.add(4));
    ...
    private static void usePut() {
        LinkedBlockingQueue<Integer> linkedBlockingQueue = new LinkedBlockingQueue<>(3);
        System.out.println("offer 1-->" + linkedBlockingQueue.offer(1));
        System.out.println("offer 2-->" + linkedBlockingQueue.offer(2));
        System.out.println("offer 3-->" + linkedBlockingQueue.offer(3));
        ...
        Runnable r = () -> {
            ...
            System.out.println(Thread.currentThread().getName() + "休眠10秒结束，并从队列中移除一个元素" + linkedBlockingQueue.remove());
        };
        new Thread(r).start();
    ...
    private static void useOfferTimeUnit() {
        ...
        try {
            System.out.println("offer 4-->" + linkedBlockingQueue.offer(4, 5, TimeUnit.SECONDS));
        ...
        try {
            System.out.println("offer 5-->" + linkedBlockingQueue.offer(5, 10, TimeUnit.SECONDS));
        } catch (InterruptedException e) {
            System.out.println("抛出InterruptedException...");
            throw new RuntimeException("抛出InterruptedException...");
        }
     ...
     * at api.blockingqueue_api.UseLinkedBlockingQueue.useRemove(UseLinkedBlockingQueue.java:166)
     * at api.blockingqueue_api.UseLinkedBlockingQueue.main(UseLinkedBlockingQueue.java:19)
     */
    ...
    private static void useTake() {
        ...
        Runnable r = () -> {
            ...
            System.out.println(Thread.currentThread().getName() + "休眠10秒结束，并往队列中插入一个元素" + linkedBlockingQueue.offer(1));
        };
        new Thread(r).start();
    ...
    private static void usePollTimeUnit() {
        ...
        try {
            System.out.println("poll() after 5s-->" + linkedBlockingQueue.poll(5, TimeUnit.SECONDS));
        } catch (InterruptedException e) {
            throw new RuntimeException(e);
        }
        ...
        try {
            System.out.println("poll() after 10s-->" + linkedBlockingQueue.poll(10, TimeUnit.SECONDS));
        } catch (InterruptedException e) {
            throw new RuntimeException(e);
        }
     ...
     * 	at api.blockingqueue_api.UseLinkedBlockingQueue.useElementAndPeek(UseLinkedBlockingQueue.java:286)
     * 	at api.blockingqueue_api.UseLinkedBlockingQueue.main(UseLinkedBlockingQueue.java:23)
     *
    ...
    private static void useElementAndPeek() {
        ...
        System.out.println("element()-->" + linkedBlockingQueue.element());
        System.out.println("poll()-->" + linkedBlockingQueue.poll());
        System.out.println("poll()-->" + linkedBlockingQueue.poll());
        System.out.println("poll()-->" + linkedBlockingQueue.poll());
        System.out.println("peek()," + linkedBlockingQueue.peek());
