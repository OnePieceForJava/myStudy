package com.wusp.dynamicProxy.jdkProxy.source;//
...
public class MyProxyGenerator {
    ...
    private static final boolean saveGeneratedFiles = (Boolean)AccessController.doPrivileged(new GetBooleanAction("sun.misc.MyProxyGenerator.saveGeneratedFiles"));
